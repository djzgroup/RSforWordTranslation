...
VALIDATION_METRIC = 'mean_cosine-rs-S2T-10000'
# main
...
parser.add_argument("--map_optimizer", type=str, default="sgd,lr=0.001", help="Mapping optimizer")
parser.add_argument("--dis_optimizer", type=str, default="sgd,lr=0.001", help="Discriminator optimizer")
...
if params.n_refinement > 0:
    ...
    trainer.reload_best(map='to_tgt')
...
# export embeddings
if params.export:
    trainer.reload_best(map='to_shared')
    trainer.export()
